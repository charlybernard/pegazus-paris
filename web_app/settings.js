// Configuration file for the web application if you want to use a graph in GraphDB, you can set the graphDBURI and graphName variables, and the finalEndpointURI variable will be automatically set to the correct value for querying the graph.
