...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{images/exemple_modelisation_adresse.pdf}
...
The location designated by an address is represented as a~\texttt{Landmark}, while the sequence of geographic references composing the address is represented through resources of type~\texttt{AddressSegment}. Since~\texttt{AddressSegment} is a subclass of~\texttt{LandmarkRelation}, each segment represents a typed relation between two landmarks.
