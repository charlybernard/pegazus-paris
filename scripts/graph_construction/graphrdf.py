...
def get_integer_literal(value: int):
    """
    Create a Literal object for an integer value (xsd:integer).

    Parameters:
    - value (int): The integer value to be turned into a Literal.

    Returns:
    - Literal: A Literal object containing the integer value with xsd:integer datatype.
    """
...
def generate_uri(namespace:Namespace=None, prefix:str=None, separator:str="_"):
    """
    ...
    """
    if prefix:
        return namespace[f"{prefix}{separator}{uuid4().hex}"]
    else:
